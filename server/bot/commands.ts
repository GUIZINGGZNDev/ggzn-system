...
export const getMainMenu = (prefix: string) => [
  ...
  "",
  `  │ 👑 [1]  ADM            ▸ ${prefix}menu 1 ou ${prefix}menu adm`,
  `  │ 🎭 [2]  ZOEIRA         ▸ ${prefix}menu 2 ou ${prefix}menu zoeira`,
  `  │ ℹ️  [3]  INFO           ▸ ${prefix}menu 3 ou ${prefix}menu info`,
  `  │ 🛡️  [4]  MODERAÇÃO      ▸ ${prefix}menu 4 ou ${prefix}menu mod`,
  `  │ 🌐 [5]  SITE OFICIAL   ▸ ${prefix}menu 5 ou ${prefix}menu site`,
  `  │ 📝 [6]  TEXTOS         ▸ ${prefix}menu 6 ou ${prefix}menu textos`,
  `  │ 🤖 [7]  IA / AUTO-RESP ▸ ${prefix}menu 7 ou ${prefix}menu ia`,
  "",
  "──────────────────────────────────────────",
  `  💡 Use ${prefix}menu + número ou nome da categoria.`,
  `  📌 Exemplo: ${prefix}menu 1  ou  ${prefix}menu adm`,
].join("\\n");
