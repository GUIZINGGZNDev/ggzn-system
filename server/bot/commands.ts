...
export const getMainMenu = (prefix: string) => [
  ...
  `${prefix}menu 1 / ADM`,
  "──────────────────────────",
  `${prefix}menu 2 / ZOEIRA`,
  "──────────────────────────",
  `${prefix}menu 3 / INFO`,
  "──────────────────────────",
  `${prefix}menu 4 / MODERAÇÃO / MOD`,
  "──────────────────────────",
  `${prefix}menu 5 / SITE OFC`,
  "──────────────────────────",
  `${prefix}menu 6 / TEXTOS`,
  "──────────────────────────",
  `${prefix}menu 7 / IA / AUTO RESPONDER`,
  "──────────────────────────",
  "",
  `Digite ${prefix}menu + número para abrir uma categoria.`,
  `Exemplo: ${prefix}menu 1`,
  "Os nomes das categorias também continuam aceitos.",
].join("\\n");
